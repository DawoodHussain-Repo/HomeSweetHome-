-- =====================================================
-- Hisaab Kitaab - Complete Schema with Data Migration
...
-- =====================================================
-- 5. TRANSACTIONS TABLE (Main voucher header)
-- =====================================================
CREATE TABLE transactions (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    user_id UUID REFERENCES users(id) ON DELETE CASCADE NOT NULL,
    legacy_tr_no INTEGER,
...
-- =====================================================
-- 6. TRANSACTION DETAILS TABLE (Line items)
-- =====================================================
...
SELECT 'Schema created. Now run the migration script to import data.' as message;
